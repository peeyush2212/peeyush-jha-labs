...
export function renderVanilla(viewEl) {
  mountHtml(
    viewEl,
    `
      <section class="grid">
        <div class="card">
          <div class="card__header">
            <h2>Vanilla option</h2>
            <p class="card__hint">Price + Greeks</p>
          </div>

          <form class="form" id="vanillaForm">
            <div class="row">
              <label class="label">
                Option type
            ...
            <div class="row">
              ...
              <label class="label">
                Strike
                <input class="control" id="strike" type="number" step="0.0001" value="105" />
              </label>
            </div>
  ...
  async function run() {
    ...
    try {
      ...
      const data = await postJson("/api/v1/pricing/vanilla", req);
      lastPayload = data;
  ...
  document.getElementById("exampleBtn").addEventListener("click", () => {
    fields.optionType.value = "call";
    fields.quantity.value = "10";
    fields.spot.value = "100";
    fields.strike.value = "105";
